...
require_once("DAO/Movie_GroupCriteriaDAO.php");

/**
 * The Movie_GroupCriteria class extends Movie_GroupDAOCriteria and is used
 ...
 * @version 1.0
 */
class Movie_GroupCriteria extends Movie_GroupCriteriaDAO
{
