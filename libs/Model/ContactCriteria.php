...
require_once("DAO/ContactCriteriaDAO.php");

/**
 * The ContactCriteria class extends ContactDAOCriteria and is used
 ...
 * @version 1.0
 */
class ContactCriteria extends ContactCriteriaDAO
{
