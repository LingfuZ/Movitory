...
require_once("DAO/Movie_GenreCriteriaDAO.php");

/**
 * The Movie_GenreCriteria class extends Movie_GenreDAOCriteria and is used
 ...
 * @version 1.0
 */
class Movie_GenreCriteria extends Movie_GenreCriteriaDAO
{
