...
require_once("DAO/Movie_ActorCriteriaDAO.php");

/**
 * The Movie_ActorCriteria class extends Movie_ActorDAOCriteria and is used
 ...
 * @version 1.0
 */
class Movie_ActorCriteria extends Movie_ActorCriteriaDAO
{
