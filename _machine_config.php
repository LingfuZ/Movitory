...
GlobalConfig::$CONNECTION_SETTING->DBName = "movitory";
GlobalConfig::$CONNECTION_SETTING->Username = "chef";
GlobalConfig::$CONNECTION_SETTING->Password = "delicious";
...
/** the root url of the application with trailing slash, for example http://localhost/movitory/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'movitory/';
